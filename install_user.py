...
RUNTIME=('interaction.py','lrc_store.py','app.py','cli.py','lyrics.py','spicy_bridge.py','terminal_ui.py','preferences.py',
...
def install(root=None):
    ...
    backup=target/'backup'/('before-0.7.2-'+timestamp)
    ...
    print('sylrics 0.7.2 instalado. Backup: '+str(backup))
